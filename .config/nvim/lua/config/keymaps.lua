...
-- none-ls
keymap("n", "<leader>gf", function () vim.lsp.buf.format({ timeout_ms = 2000 }) end, { desc = "Format buffer", silent = true })
...
-- copilot
keymap("n", "<leader>cc", ":CopilotChat ", { desc = "Open Copilot Chat windows with optional input." })
keymap("v", "<leader>cf", ":CopilotChatFix<CR>", { desc = "Copilot: Attempt to fix selected code." })
keymap("v", "<leader>co", ":CopilotChatOptimize", { desc = "Copilot: Optimize the selected code." })
